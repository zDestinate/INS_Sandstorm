...
Insurgency\Binaries\Win64\InsurgencyServer-Win64-Shipping.exe %strMap%?port=27102?queryport=27131?MaxPlayers=10?Game=%strGameMode% -log -AdminList=Admins -MapCycle=MapCycle -ruleset=%strRuleSet% -ApiKey=XXXXXXXXXXXXXXXXXXXXXXXXXXXXX -GameStats -EnableCheats -NoEAC
